...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-ep-477-erd-s-problem-477-f0b1cb38-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/EP-477"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-ep-477-erd-s-problem-477-f0b1cb38-v1",
      "problem_contract_sha256": "980d9a9351c3cea6e20881ff777413a10954ed4f66052ee81d6e1c9f10c1be57",
      "problem_id": "problem:um-ep-477-erd-s-problem-477-f0b1cb38",
      "route_id": "route:um-ep-477-erd-s-problem-477-f0b1cb38-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-ep-477-erd-s-problem-477-f0b1cb38-source-fidelity-01",
      "graph_id": "graph:um-ep-477-erd-s-problem-477-f0b1cb38-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-ep-477-erd-s-problem-477-f0b1cb38-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-ep-477-erd-s-problem-477-f0b1cb38-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Is there a polynomial $f:\\mathbb{Z}\\to \\mathbb{Z}$ of degree at least $2$ and a set $A\\subset \\mathbb{Z}$ such that for any $n\\in \\mathbb{Z}$ there is exactly one $a\\in A$ and $b\\in \\{ f(n) : n\\in\\mathbb{Z}\\}$ such that $n=a+b$?"
          },
          "statement_sha256": "a6dc23a92c98f88edc8edc49aa3aaeff737775c6ebf35ae03c8b297536bfce64"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-ep-477-erd-s-problem-477-f0b1cb38-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-ep-477-erd-s-problem-477-f0b1cb38-root",
      "route_id": "route:um-ep-477-erd-s-problem-477-f0b1cb38-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-ep-477-59cd4af05680",
        "url": "https://www.unsolvedmath.com/problems/EP-477"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
